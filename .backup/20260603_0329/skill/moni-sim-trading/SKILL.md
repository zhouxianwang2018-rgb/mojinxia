...
| 13 | Scenario触达率21%、进攻型0触发、引擎推荐无法追踪绩效 | P1 | 🟡 v1.1 Feature设计中 → `products/摸金虾/roadmap/20260603-engine-path-closure.md` |
...
## v1.1 引擎路径闭环（Feature 设计中）

> 完整设计文档：`products/摸金虾/roadmap/20260603-engine-path-closure.md`  
...
- 触达率 < 30% 自动告警
- **产品设计文档**：`~/.hermes/products/摸金虾/`（changelog / roadmap 多文件 / DEVELOPMENT），与 skill 操作手册分离
- **Roadmap 结构**：`products/摸金虾/roadmap/INDEX.md`（总索引）→ 独立 feature 文件（`YYYYMMDD-description.md`）+ `backlog.md` + `done/`
- **当前活跃 feature**：v1.1 引擎路径闭环 → `products/摸金虾/roadmap/20260603-engine-path-closure.md`（含业务需求 / 5 指标 / Phase 0-3 / 技术方案）
...
完整开发流程见产品设计文档 `~/.hermes/products/摸金虾/DEVELOPMENT.md`。
